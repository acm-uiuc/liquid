...
class Quote(models.Model):
   ...
   def save(self, *args, **kwargs):
      ...
      # Hyperlink hashtags
      self.quote_text = re.sub("(^|(?<=\W))#(?P<tag>\w+)", "<a href='/quotedb/?q=%23\g<tag>'>%23\g<tag></a>", self.quote_text)
   
      # Hyperlink author
      self.quote_source = "<a href='/quotedb/?author=" + self.quote_source + "'>" + self.quote_source + "</a>"
