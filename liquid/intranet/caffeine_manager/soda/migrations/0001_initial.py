...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('soda_soda', (
            ...
            ('total_sold', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11)),
        ))
        db.send_create_signal('soda', ['Soda'])

        # Adding M2M table for field votes on 'Soda'
        m2m_table_name = db.shorten_name('soda_soda_votes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('soda', models.ForeignKey(orm['soda.soda'], null=False)),
            ('member', models.ForeignKey(orm['intranet.member'], null=False))
        ))
        db.create_unique(m2m_table_name, ['soda_id', 'member_id'])


    def backwards(self, orm):
        # Deleting model 'Soda'
        db.delete_table('soda_soda')

        # Removing M2M table for field votes on 'Soda'
        db.delete_table(db.shorten_name('soda_soda_votes'))
