...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tray.tray_number'
        db.add_column('caffeine_manager_tray', 'tray_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tray.tray_number'
        db.delete_column('caffeine_manager_tray', 'tray_number')
