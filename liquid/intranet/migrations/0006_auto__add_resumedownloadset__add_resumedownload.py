...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResumeDownloadSet'
        db.create_table('intranet_resumedownloadset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('level', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('seeking', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('acm', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('graduation_start', self.gf('django.db.models.fields.DateField')(null=True)),
            ('graduation_end', self.gf('django.db.models.fields.DateField')(null=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('intranet', ['ResumeDownloadSet'])

        # Adding model 'ResumeDownload'
        db.create_table('intranet_resumedownload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intranet.ResumeDownloadSet'])),
            ('hightest_id', self.gf('django.db.models.fields.IntegerField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('intranet', ['ResumeDownload'])


    def backwards(self, orm):
        
        # Deleting model 'ResumeDownloadSet'
        db.delete_table('intranet_resumedownloadset')

        # Deleting model 'ResumeDownload'
        db.delete_table('intranet_resumedownload')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 17, 28, 30, 832520)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 17, 28, 30, 832362)'}),
        ...
        'intranet.resumedownload': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'hightest_id': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
