...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('intranet_recruiter', (
            ('user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('expires', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('intranet', ['Recruiter'])


    def backwards(self, orm):
        
        # Deleting model 'Recruiter'
        db.delete_table('intranet_recruiter')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 18, 34, 9, 936761)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 18, 34, 9, 936620)'}),
