...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Group.mailing_list'
        db.delete_column('intranet_group', 'mailing_list')

        # Adding field 'Group.mailing_list'
        db.add_column('intranet_group', 'mailing_list', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['django_mailman.List']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Group.mailing_list'
        db.delete_column('intranet_group', 'mailing_list_id')
        
        # Adding field 'Group.mailing_list'
        db.add_column('intranet_group', 'mailing_list', self.gf('django.db.models.fields.EmailField')(default='', max_length=60), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 16, 23, 47, 385575)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 13, 16, 23, 47, 385421)'}),
