...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePerson.resume_uuid'
        db.add_column('intranet_resumeperson', 'resume_uuid',
                      self.gf('django.db.models.fields.CharField')(default='68bd1e65-1dc6-4a70-b07e-3df9b99c6e88', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePerson.resume_uuid'
        db.delete_column('intranet_resumeperson', 'resume_uuid')
    ...
    models = {
        ...
        'intranet.resumeperson': {
            ...
            'resume_uuid': ('django.db.models.fields.CharField', [], {'default': "'68bd1e65-1dc6-4a70-b07e-3df9b99c6e88'", 'max_length': '255'}),
