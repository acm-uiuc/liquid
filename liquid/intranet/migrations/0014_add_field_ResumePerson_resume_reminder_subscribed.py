...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePerson.resume_reminder_subscribed'
        db.add_column('intranet_resumeperson', 'resume_reminder_subscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePerson.resume_reminder_subscribed'
        db.delete_column('intranet_resumeperson', 'resume_reminder_subscribed')
    ...
    models = {
        ...
        'intranet.resumeperson': {
            ...
            'resume_reminded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 1, 0, 0)'}),
            'resume_reminder_subscribed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'resume_uuid': ('django.db.models.fields.CharField', [], {'default': "'babed0d4-1479-4ec2-b64d-c046cca743ac'", 'max_length': '255'}),
