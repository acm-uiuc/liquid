...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResumeDownloadSet.owner'
        db.alter_column('intranet_resumedownloadset', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intranet.Recruiter']))


    def backwards(self, orm):
        
        # Changing field 'ResumeDownloadSet.owner'
        db.alter_column('intranet_resumedownloadset', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 19, 50, 50, 708270)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 8, 19, 50, 50, 708130)'}),
        ...
        'intranet.resumedownloadset': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['intranet.Recruiter']"}),
