...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResumePerson'
        db.create_table('intranet_resumeperson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('netid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('seeking', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('intranet', ['ResumePerson'])

        # Adding model 'Resume'
        db.create_table('intranet_resume', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intranet.ResumePerson'], null=True)),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('resume', self.gf('utils.fields.ContentTypeRestrictedFileField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('intranet', ['Resume'])


    def backwards(self, orm):
        
        # Deleting model 'ResumePerson'
        db.delete_table('intranet_resumeperson')

        # Deleting model 'Resume'
        db.delete_table('intranet_resume')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 7, 1, 38, 49, 340872)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 7, 1, 38, 49, 340715)'}),
