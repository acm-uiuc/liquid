...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recruiter.level'
        db.add_column('intranet_recruiter', 'level',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Recruiter.logo'
        db.add_column('intranet_recruiter', 'logo',
                      self.gf('utils.fields.ContentTypeRestrictedFileField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Recruiter.url'
        db.add_column('intranet_recruiter', 'url',
    ...
    def backwards(self, orm):
        ...
        db.create_table('vending', (
            ...
            ('caffeine', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        db.send_create_signal('intranet', ['Vending'])

        # Deleting field 'Recruiter.level'
        db.delete_column('intranet_recruiter', 'level')

        # Deleting field 'Recruiter.logo'
        db.delete_column('intranet_recruiter', 'logo')

        # Deleting field 'Recruiter.url'
        db.delete_column('intranet_recruiter', 'url')
    ...
    models = {
        ...
        'intranet.resumeperson': {
            ...
            'resume_reminded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)'}),
            'resume_reminder_subscribed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'resume_uuid': ('django.db.models.fields.CharField', [], {'default': "'25d0c0d0-aebb-4979-ac00-1276853bbdcd'", 'max_length': '255'}),
