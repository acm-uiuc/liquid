...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePerson.resume_reminded_at'
        db.add_column('intranet_resumeperson', 'resume_reminded_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePerson.resume_reminded_at'
        db.delete_column('intranet_resumeperson', 'resume_reminded_at')
    ...
    models = {
        ...
        'intranet.resumeperson': {
            ...
            'resume_reminded_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'resume_uuid': ('django.db.models.fields.CharField', [], {'default': "'54a21e25-d6c6-4c39-8277-bd77b851f5df'", 'max_length': '255'}),
