...
"""
Manual modifications, since South ignores DB routers
See https://stackoverflow.com/questions/7029228/
"""
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vending', (
            ('uid', self.gf('django.db.models.fields.IntegerField')(max_length=11, primary_key=True)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 14, 1, 21, 42, 575212)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 14, 1, 21, 42, 575157)'}),
        ...
        'intranet.resumeperson': {
            ...
            'resume_reminded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 14, 1, 21, 42, 512519)'}),
            'resume_reminder_subscribed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'resume_uuid': ('django.db.models.fields.CharField', [], {'default': "'87027078-1b04-4db3-9251-d33add518487'", 'max_length': '255'}),
