...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PreResumePerson'
        db.create_table('intranet_preresumeperson', (
            ('resumeperson_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['intranet.ResumePerson'], unique=True, primary_key=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('intranet', ['PreResumePerson'])

        # Adding unique constraint on 'PreMember', fields ['netid']
        db.create_unique('intranet_premember', ['netid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PreMember', fields ['netid']
        db.delete_unique('intranet_premember', ['netid'])

        # Deleting model 'PreResumePerson'
        db.delete_table('intranet_preresumeperson')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 18, 40, 47, 340678)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 18, 40, 47, 340244)'}),
