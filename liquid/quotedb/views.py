...
def main(request):
   ...
   quotes = Quote.objects.all().order_by("created_at")[quote_start_index:quote_end_index]
...
def add(request):
   ...
   if request.method == 'POST':
      ...
      return render_to_response('quotedb/main.html',{"section":"quotedb","page":'main',"pages":pages},context_instance=RequestContext(request))
   else:
      return render_to_response('quotedb/add.html',{"section":"quotedb","page":'add',"pages":pages,"form":QuoteForm},context_instance=RequestContext(request))
