...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vote_vote', (
            ...
            ('poll', self.gf('django.db.models.fields.IntegerField')()),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 16, 37, 57, 957719)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 16, 37, 57, 957571)'}),
        ...
        'vote.vote': {
            ...
            'poll': ('django.db.models.fields.IntegerField', [], {}),
