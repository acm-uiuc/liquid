...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BanksPost'
        db.create_table('banks_bankspost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intranet.Member'])),
        ))
        db.send_create_signal('banks', ['BanksPost'])


    def backwards(self, orm):
        
        # Deleting model 'BanksPost'
        db.delete_table('banks_bankspost')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 20, 24, 50, 903421)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 29, 20, 24, 50, 903336)'}),
        ...
        'banks.bankspost': {
            'Meta': {'ordering': "['-date_publish']", 'object_name': 'BanksPost'},
            ...
            'subtitle': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
